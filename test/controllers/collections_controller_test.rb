...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference("Collection.count") do
      post collections_url, params: { collection: { body: @collection.body, likes: @collection.likes, views: @collection.views } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { body: @collection.body, likes: @collection.likes, views: @collection.views } }
